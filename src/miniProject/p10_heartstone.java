...
public class p10_heartstone extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					p10_heartstone frame = new p10_heartstone();
	...
	public p10_heartstone() {
		...
		lblNewLabel.setBounds(371, 43, 158, 45);
		...
		textPane.setBounds(42, 343, 488, 204);
		contentPane.add(textPane);

		JLabel heartstone = new JLabel("");
		Image img010 = new ImageIcon(this.getClass().getResource("/Bhearthstone.png")).getImage();
		heartstone.setIcon(new ImageIcon(img010));
		heartstone.setHorizontalAlignment(SwingConstants.CENTER);
		heartstone.setBounds(42, 43, 230, 272);
		contentPane.add(heartstone);

		JLabel textField = new JLabel();
		DecimalFormat value = new DecimalFormat("#.##");
		textField.setText("\u0E04\u0E30\u0E41\u0E19\u0E19   " + value.format(gui.total10));
			...
			public void actionPerformed(ActionEvent e) {
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						gui.total10 = gui.s10 / gui.n10;
						textField.setText("§–·ππ   " + value.format(gui.total10));
						show.setVisible(v);
					}
				});
		...
		JTextPane txtpnBattlenet = new JTextPane();
		txtpnBattlenet.setEditable(false);
		txtpnBattlenet.setText(
				"\u0E1F\u0E23\u0E35\r\n\r\n\u0E42\u0E2B\u0E25\u0E14\u0E43\u0E19 Battle.net , Google play , app store\r\n\r\n\u0E41\u0E19\u0E27 \u0E01\u0E25\u0E22\u0E38\u0E17\u0E18\u0E4C , \u0E1C\u0E08\u0E0D\u0E20\u0E31\u0E22");
		txtpnBattlenet.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtpnBattlenet.setBackground(SystemColor.activeCaption);
		txtpnBattlenet.setBounds(321, 101, 312, 118);
		contentPane.add(txtpnBattlenet);
	}
