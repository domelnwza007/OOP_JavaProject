...
public class p08_starwars_jedi_fallen_order extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					p08_starwars_jedi_fallen_order frame = new p08_starwars_jedi_fallen_order();
	 ...
	 * Create the frame.
	 */
	public p08_starwars_jedi_fallen_order() {
		...
		JLabel lblNewLabel = new JLabel("STAR WARS Jedi: Fallen Order");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel.setBounds(338, 45, 250, 45);
		...
		textPane.setText(
				"\u0E04\u0E27\u0E32\u0E21\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E23\u0E30\u0E1A\u0E1A\r\n\u0E02\u0E31\u0E49\u0E19\u0E15\u0E48\u0E33:\r\n\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E2B\u0E19\u0E48\u0E27\u0E22\u0E1B\u0E23\u0E30\u0E21\u0E27\u0E25\u0E1C\u0E25\u0E41\u0E25\u0E30\u0E23\u0E30\u0E1A\u0E1A\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23\u0E41\u0E1A\u0E1A 64 \u0E1A\u0E34\u0E15\r\n\u0E23\u0E30\u0E1A\u0E1A\u0E1B\u0E0F\u0E34\u0E1A\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23: 64-bit Windows 7/8.1/10\r\n\u0E2B\u0E19\u0E48\u0E27\u0E22\u0E1B\u0E23\u0E30\u0E21\u0E27\u0E25\u0E1C\u0E25: AMD FX-6100/Intel i3-3220 or Equivalent\r\n\u0E2B\u0E19\u0E48\u0E27\u0E22\u0E04\u0E27\u0E32\u0E21\u0E08\u0E33: \u0E41\u0E23\u0E21 8 GB\r\n\u0E01\u0E23\u0E32\u0E1F\u0E34\u0E01\u0E2A\u0E4C: AMD Radeon HD 7750, NVIDIA GeForce GTX 650 or Equivalent\r\nDirectX: \u0E40\u0E27\u0E2D\u0E23\u0E4C\u0E0A\u0E31\u0E19 11\r\n\u0E2B\u0E19\u0E48\u0E27\u0E22\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25: \u0E1E\u0E37\u0E49\u0E19\u0E17\u0E35\u0E48\u0E27\u0E48\u0E32\u0E07\u0E17\u0E35\u0E48\u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E43\u0E0A\u0E49\u0E07\u0E32\u0E19 55 GB\r\n");
		textPane.setBounds(42, 343, 488, 249);
		contentPane.add(textPane);

		JLabel starwars_jedi_fallen_order = new JLabel("");
		Image img008 = new ImageIcon(this.getClass().getResource("/Bstar wars jedi fallen order.jpg")).getImage();
		starwars_jedi_fallen_order.setIcon(new ImageIcon(img008));
		starwars_jedi_fallen_order.setHorizontalAlignment(SwingConstants.CENTER);
		starwars_jedi_fallen_order.setBounds(42, 43, 230, 272);
		contentPane.add(starwars_jedi_fallen_order);

		JLabel textField = new JLabel();
		DecimalFormat value = new DecimalFormat("#.##");
		textField.setText("\u0E04\u0E30\u0E41\u0E19\u0E19   " + value.format(gui.total8));
			...
			public void actionPerformed(ActionEvent e) {
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						gui.total8 = gui.s8 / gui.n8;
						textField.setText("§–·ππ   " + value.format(gui.total8));
						show.setVisible(v);
					}
				});
		...
		textPane_1.setBounds(321, 101, 181, 118);
