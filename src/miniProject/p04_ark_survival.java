...
public class p04_ark_survival extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					p04_ark_survival frame = new p04_ark_survival();
	...
	public p04_ark_survival() {
		...
		JLabel lblNewLabel = new JLabel("ARK: Survival Evolved");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel.setBounds(371, 43, 223, 28);
		contentPane.add(lblNewLabel);

		JTextPane txtpnWindows = new JTextPane();
		txtpnWindows.setEditable(false);
		txtpnWindows.setBackground(SystemColor.activeCaption);
		txtpnWindows.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtpnWindows.setText(
		...
		txtpnWindows.setBounds(42, 343, 488, 249);
		contentPane.add(txtpnWindows);

		JLabel ark_survival = new JLabel("");
		ark_survival.setHorizontalAlignment(SwingConstants.CENTER);
		Image img004 = new ImageIcon(this.getClass().getResource("/Bark survival.png")).getImage();
		ark_survival.setIcon(new ImageIcon(img004));
		ark_survival.setBounds(42, 43, 230, 272);
		contentPane.add(ark_survival);
		...
		textField.setText("\u0E04\u0E30\u0E41\u0E19\u0E19   " + value.format(gui.total4));
			...
			public void actionPerformed(ActionEvent e) {
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						gui.total4 = gui.s4 / gui.n4;
						textField.setText("§–·ππ   " + value.format(gui.total4));
						show.setVisible(v);
					}
				});
